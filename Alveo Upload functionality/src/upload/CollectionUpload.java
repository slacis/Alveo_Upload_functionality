...
/**
 * A class to create Alveo item via Alveo API and upload files to that item
 * 
 * @author Kun He
 *
 */
...
public class CollectionUpload {
	...
	public static int upload(String path, List<String> docIDs, String key, String collection, String metadata)
			throws IOException {
		...
		if (Integer.valueOf(rcode) == 200) {
			...
			JOptionPane.showMessageDialog(null, "Invalid Alveo Collection Name", "InfoBox: " + "Error Message",
