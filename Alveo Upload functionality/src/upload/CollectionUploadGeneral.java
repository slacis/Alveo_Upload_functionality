...
public class CollectionUploadGeneral {
	...
	public static int upload (String path, String key, String collection) throws IOException{
...
//					LOGGER.info( "FILE:" + (txtFile.exists() && xmlFile.exists()));
					...
					try{
					    ...
					    Part[] parts = {new FilePart( "file", file ), 
					    		new StringPart( "items",MetadataGeneral.createMetadata(docID,docName,txtFileBytes, fileExs).toString()) };
